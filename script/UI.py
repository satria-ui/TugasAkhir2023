...
def main():
    ...
    examples=[
        [os.path.join(os.path.dirname(__file__),"audio/recording1 - A.wav")],
        [os.path.join(os.path.dirname(__file__),"audio/recording2 - D.wav")],
        [os.path.join(os.path.dirname(__file__),"audio/recording3 - N.wav")],
        [os.path.join(os.path.dirname(__file__),"audio/recording4 - S.wav")],
    ],
